    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main className="p-4 md:p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Comprehensive Supabase connectivity and configuration check</p>
        </div>
              ...
              {tests.map((test, index) => (
                <div key={index} className="flex items-start space-x-4 p-4 rounded-lg border bg-white">
                  ...
                  <div className="flex-1">
                    ...
                    {test.details && (
                      <p className="text-sm text-gray-500 mt-2 font-mono bg-gray-50 p-2 rounded break-all">
                        {test.details}
                      </p>
                    )}
                  </div>
...
export default AdminConnectionTest;