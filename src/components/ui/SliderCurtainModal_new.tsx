...
export function SliderCurtainModal({ open, onOpenChange, product, onAddToCart, onBuyNow, addToCart }: SliderCurtainModalProps) {
  ...
  const staticProductData = {
    ...
    help_text: 'Our smart slider curtains offer automated control with smartphone integration. Choose between Zigbee (requires hub) or WiFi models based on your smart home setup.',
                  ...
                  {selectedImage === 0 && (allImages[0].includes('youtube.com') || allImages[0].includes('youtu.be')) ? (
                    <div className="w-full h-full rounded-lg overflow-hidden relative bg-white">
                      <iframe
                        ...
                        src={`https://www.youtube-nocookie.com/embed/APm2EDVBljw?autoplay=1&mute=1&controls=0&loop=1&playlist=APm2EDVBljw&vq=hd480&modestbranding=1&iv_load_policy=3`}
                      ...
                      >
                        {image.includes('youtube.com') || image.includes('youtu.be') ? (
                          <div className="w-full h-full relative">
                            <img 
                              src="https://img.youtube.com/vi/APm2EDVBljw/maxresdefault.jpg" 
                              alt="Video Thumbnail" 
              ...
              <div className="mb-6">
                ...
                <div className="text-sm text-gray-700 font-medium space-y-1">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="font-bold">Track included — curtain fabrics not included</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-gray-400 font-bold">*</span>
                  ...
                  {['2m set', '3m set', '4m set', '5m set', '6m set', '7m set', '8m set'].map((size) => (
                    <button
                      ...
                      className={`flex-1 py-1.5 text-sm rounded border-2 transition-all font-medium ${
                        selectedSize === size ? 'border-black bg-gray-100 text-black' : 'border-gray-200 hover:border-black text-gray-700'
                      }`}
                    >
                      {size}
                    </button>
        ...
        <DialogContent className="max-w-lg p-0 rounded-2xl bg-white shadow-2xl border-0 overflow-hidden">
          ...
          <div style={{ backgroundColor: '#7e8898' }} className="px-6 py-4 relative">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-xs">Smart Slider Curtain Features</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-5">
            <p className="text-gray-600 mb-4 text-sm leading-relaxed">
              The Smart Slider Curtain combines convenience, style, and smart-home functionality:
            </p>
            ...
            <div className="space-y-3">
              <div className="flex gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">App, voice control, or remote operation</p>
                </div>
              </div>
              ...
              <div className="flex gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Adjustable track up to 8 feet</p>
                </div>
              </div>
              ...
              <div className="flex gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">HomeKit, Google Home, SmartThings</p>
                </div>
              </div>
              ...
              <div className="flex gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Move manually anytime</p>
                </div>
              </div>
              ...
              <div className="flex gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Smooth, quiet, premium operation</p>
                </div>
              </div>
            </div>
          </div>
