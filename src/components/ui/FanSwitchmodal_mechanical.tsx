          ...
          <div className="flex flex-col lg:contents gap-0">
                        ...
                        <div className="text-sm text-gray-500">
                          <ul className="space-y-2">
                            <li className="flex items-start gap-2">
                              ...
                              Traditional mechanical fan speed controller with reliable physical switches
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                              Variable speed control for ceiling fans and ventilation systems
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                              Durable construction with long-lasting mechanical components
                            </li>
                          </ul>
                        </div>
                      )}
                      {activeTab === 'bestfor' && (
                        <div className="text-sm text-gray-500">
                          <ul className="space-y-2">
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                              Max Current: 6A, Max Voltage: 250V AC, Rated Power: 1500W
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                              Size: 86mm x 86mm x 40mm, Mechanical Life: 50,000 on/off cycles
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                              Standard electrical box mounting, no neutral wire required
                            </li>
                          </ul>
                        </div>
                      )}
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-4 gap-3">
                {['White', 'Gold', 'Black', 'Grey'].map((color) => {
                  ...
                  return (
                    <div key={color} className="text-center">
                      ...
                      >
                        <img 
                          src={`/assets/Fan_switch/mechanical/${color.toLowerCase()}.png`}
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            setSelectedGangImage(`/assets/Fan_switch/mechanical/${color.toLowerCase()}.png`);
        ...
        <DialogContent className="max-w-md p-0 rounded-2xl bg-white shadow-2xl border-0">
          <div className="p-6">
            ...
            <p className="text-gray-600 text-center mb-6 leading-relaxed">
              The Mechanical Fan Speed Controller is a reliable, traditional wall switch designed for variable speed control of ceiling fans. It features durable mechanical components for long-lasting performance.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Variable Speed Control</h3>
                  <p className="text-sm text-gray-600">Smooth speed adjustment for ceiling fans with reliable mechanical operation.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Durable Construction</h3>
                  <p className="text-sm text-gray-600">6A max current, 250V AC, robust mechanical components with 50,000 cycle life.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Standard electrical box mounting, no neutral wire required for simple setup.</p>
                </div>
              </div>
            </div>
          </div>
