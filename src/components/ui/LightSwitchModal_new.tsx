...
export function LightSwitchModal({ open, onOpenChange, product, onAddToCart, onBuyNow, addToCart }: LightSwitchModalProps) {
  ...
  const lightSwitchProducts = [
    {
      ...
      price: 3500,
      image: '/assets/light_switch/touch_switch/white_1gang.png',
      additional_images: JSON.stringify([
        '/assets/light_switch/touch_switch/Lw1.jpg',
        '/assets/light_switch/touch_switch/Lw2.jpg',
        '/assets/light_switch/touch_switch/Lw3.jpg',
        '/assets/light_switch/touch_switch/Lw4.jpg',
        '/assets/light_switch/touch_switch/Lw5.jpg',
        '/assets/light_switch/touch_switch/Lw6.jpg'
      ]),
    ...
    },
    {
      ...
      price: 3650,
      image: '/assets/light_switch/touch_switch/white_2gang.png',
      additional_images: JSON.stringify([
        '/assets/light_switch/touch_switch/Lw1.jpg',
        '/assets/light_switch/touch_switch/Lw2.jpg',
        '/assets/light_switch/touch_switch/Lw3.jpg',
      ...
      variants: JSON.stringify([{ price: 3650, discount_price: 0 }]),
    ...
    },
    {
      ...
      price: 3800,
      image: '/assets/light_switch/touch_switch/white_3gang.png',
      additional_images: JSON.stringify([
        '/assets/light_switch/touch_switch/Lw1.jpg',
        '/assets/light_switch/touch_switch/Lw2.jpg',
        '/assets/light_switch/touch_switch/Lw3.jpg',
  ...
  const boilerSwitchProducts = [
    {
      ...
      price: 3700,
      discount_price: 0,
      image: '/assets/Boiler_switch/touch_boiler_switch/btouch1.jpg',
      image2: '/assets/Boiler_switch/touch_boiler_switch/btouch2.jpg',
      image3: '/assets/Boiler_switch/touch_boiler_switch/btouch3.jpg',
      image4: '/assets/Boiler_switch/touch_boiler_switch/btouch4.jpg',
      image5: '/assets/Boiler_switch/touch_boiler_switch/btouch5.jpg',
  ...
  const fanSwitchProducts = [
    {
      ...
      image2: '/assets/Fan_switch/touch/touch2.png',
      image3: '/assets/Fan_switch/touch/touch3.png',
      image4: '/assets/Fan_switch/touch/touch4.png',
      image5: '/assets/Fan_switch/touch/touch5.png',
      additional_images: JSON.stringify([
        '/assets/Fan_switch/touch/touch1.png',
    ...
    },
    {
      ...
      variants: JSON.stringify([
        { name: 'White', price: 4000, discount_price: 0, color: 'White' },
        { name: 'Gold', price: 4000, discount_price: 0, color: 'Gold' },
        { name: 'Black', price: 4000, discount_price: 0, color: 'Black' }
      ]),
  ...
  useEffect(() => {
    if (selectedSwitchType) {
      ...
      if (selectedSwitchType === 'boiler' || selectedSwitchType === 'fan') {
        ...
        if (selectedGang) {
          const gangNumber = selectedGang === 'one' ? '1' : selectedGang === 'two' ? '2' : '3';
  ...
  const getAllSwitchImages = () => {
    if (selectedSwitchType && selectedProduct) {
  ...
  const handleAddToCart = async () => {
    ...
    if (selectedSwitchType === 'light' && selectedColor && !selectedProduct) {
      toast({
    ...
    if (selectedSwitchType === 'fan' && !selectedColor) {
      toast({
        title: "Color Selection Required",
        description: "Please select a color for the fan switch.",
        variant: "destructive"
      });
      return;
    }

    if (selectedSwitchType === 'boiler' && !selectedColor) {
      toast({
        title: "Color Selection Required",
        description: "Please select a color for the boiler switch.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      if (selectedSwitchType === 'light') {
        const gangDisplay = selectedGang === 'one' ? '1' : selectedGang === 'two' ? '2' : '3';
      ...
      const unitPrice = currentPrice + (engravingText ? (selectedProduct?.engraving_price || currentProductData.engraving_price || 200) : 0);
      if (addToCart) {
        addToCart({
            ...
            <div className="mb-6">
              <h1 className="text-xl lg:text-2xl font-bold text-black mb-4 lg:mb-5 leading-tight tracking-tight">
                {selectedSwitchType ? (
                  ...
                  selectedSwitchType === 'boiler' ? 'Boiler Switch' : 'Touch Switch'
                ) : (
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-4 gap-3">
                <div className="flex flex-col items-center">
                  ...
                  >
                    <img 
                      src="/assets/light_switch/touch_switch/Lw1.jpg"
                ...
                <div className="flex flex-col items-center">
                  ...
                  >
                    <img 
                      src="/assets/Fan_switch/touch/fan_switch.png"
                ...
                <div className="flex flex-col items-center">
                  ...
                  >
                    <img 
                      src="/assets/Boiler_switch/touch_boiler_switch/btouch1.jpg"
                      alt="Boiler Switch"
                      className="w-full h-full object-cover"
                    />
                  </div>
            ...
            {selectedSwitchType && (
              <div className="mb-4">
                ...
                <div className="flex gap-4">
                  {(selectedSwitchType === 'light' ? ['White', 'Golden', 'Black'] : 
                   selectedSwitchType === 'fan' ? ['White', 'Gold', 'Black'] : 
                   ['White']).map((color) => {
                  ...
                  {['one', 'two', 'three'].map((gang) => {
                    ...
                    return (
                      <div key={gang} className="flex flex-col items-center">
                        ...
                        >
                          <img 
                            src={`/assets/light_switch/touch_switch/${selectedColor ? (selectedColor === 'Golden' ? 'gold' : selectedColor.toLowerCase()) : 'white'}_${gangNumber}gang.png`}
                          ...
                          {selectedColor && (
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                setSelectedGangImage(`/assets/light_switch/touch_switch/${selectedColor === 'Golden' ? 'gold' : selectedColor.toLowerCase()}_${gangNumber}gang.png`);
